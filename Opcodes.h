...
#define BC0 VR4300_BUILD_OP(BC0, INFO1(NONE))
#define BC1 VR4300_BUILD_OP(BC1, INFO1(NONE))
#define BC2 VR4300_BUILD_OP(BC1, INFO1(NONE))
...
#define ADDIU VR4300_BUILD_OP(ADDIU, INFO2(NEED_RS, WRITE_RT))

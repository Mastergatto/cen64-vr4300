...
#define ADD VR4300_BUILD_OP(ADD_SUB, INFO1(NONE))
...
#define ADDU VR4300_BUILD_OP(ADDU_SUBU, INFO1(NONE))
...
#define SUB VR4300_BUILD_OP(ADD_SUB, INFO1(NONE))
#define SUBU VR4300_BUILD_OP(ADDU_SUBU, INFO1(NONE))
